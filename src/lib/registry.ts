...
export const TOOLS: Tool[] = [
  ...
  // ------------------------------------------------------------ Finance
  {
    ...
    seo: {
      ...
      description:
        'Calculate your Nepal income tax for FY 2082/83 in seconds. Latest slabs for individuals and couples, SST, and marginal rates. Runs fully in your browser.',
      keywords: ['nepal income tax calculator', 'income tax nepal 2082 83', 'salary tax nepal', 'tax slab nepal 2082'],
    },
  },
  {
    slug: 'emi-calculator',
    ...
    seo: {
      ...
      keywords: ['emi calculator', 'loan calculator', 'home loan emi', 'monthly payment calculator'],
    },
  },
  // ---------------------------------------------------------- Developer
  {
